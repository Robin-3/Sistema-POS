...
const toastTypes = {
  info: {
    ...
    buttonStyles:
      'bg-blue-50 text-blue-500 focus:ring-blue-400 hover:bg-blue-200 dark:hover:bg-gray-700 dark:text-blue-400 dark:bg-gray-800'
  },
  danger: {
    icon: OctagonX,
    styles:
    ...
    buttonStyles:
      'bg-red-50 text-red-500 focus:ring-red-400 hover:bg-red-200 dark:hover:bg-gray-700 dark:text-red-400 dark:bg-gray-800'
  },
  success: {
    icon: CircleCheck,
    styles:
    ...
    buttonStyles:
      'bg-green-50 text-green-500 focus:ring-green-400 hover:bg-green-200 dark:hover:bg-gray-700 dark:text-green-400 dark:bg-gray-800'
  },
  alert: {
    icon: TriangleAlert,
    styles:
    ...
    buttonStyles:
      'bg-yellow-50 text-yellow-500 focus:ring-yellow-400 hover:bg-yellow-200 dark:hover:bg-gray-700 dark:text-yellow-300 dark:bg-gray-800'
  },
  dark: {
    icon: CircleAlert,
...
const Toast = ({
  ...
  type: 'info' | 'danger' | 'success' | 'alert' | 'dark';
  message: string;
  duration: number;
}) => {
